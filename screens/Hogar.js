      ...
      barStyle="dark-content"/> 
        <View style={ styles.headerWrapper }>
          ...
          <View style={ styles.greatingWrapperPolizas }>
            <Text style={ styles.dayWrapper }>Hogar</Text>
            <Text style={ styles.dateWrapper}>Procesos relacionados con tu seguro de hogar</Text>
          </View>
          <View style={ styles.menuWrapperPoliza }>
           ...
           <TouchableOpacity onPress={WhatsApp}>
            <Card
              image={require('./../assets/Img/obrero.png')}
              title1="Solicitar asistencia"
              progress="100%"
              date="Plomería | Electricidad | Otros servicios" />
          </TouchableOpacity>
